...
execute if entity @s[tag=key.owner] run function keyconomy:__private__/shop/hit/owner/try_destroy
execute if entity @s[tag=!key.owner] run function keyconomy:__private__/shop/hit/customer/give_items
