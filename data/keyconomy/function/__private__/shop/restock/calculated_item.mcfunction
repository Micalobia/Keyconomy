...
execute as @n[type=item,tag=key.temp] at @n[type=marker,tag=key.shop.active] run function keyconomy:__private__/misc/assign_item with storage keyconomy:data macro
