...
execute if entity @s[tag=key.owner,tag=!key.shop.creative] run function keyconomy:__private__/shop/restock/start
execute unless entity @s[tag=key.owner,tag=!key.shop.creative] run function keyconomy:__private__/shop/interact/customer/details
