...
execute if entity @s[gamemode=!creative,tag=key.owner,tag=!key.shop.creative] run function keyconomy:__private__/shop/restock/start
execute unless entity @s[gamemode=!creative,tag=key.owner,tag=!key.shop.creative] run function keyconomy:__private__/shop/interact/customer/details
